...
do
    OUTPUT_DIR="/data/cat/ws/s1787956-cobra/data/cobraII-feats-cptac-${job_id}-${magnification}x-e${epoch}/${cohort}"
    FEAT_DIR="/data/cat/ws/s1787956-cobra/data/features-cptac/features-${magnification}x/virchow2/CPTAC-${cohort}/virchow2-stamp-maru-21-12-24"
