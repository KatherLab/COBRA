...
do
    OUTPUT_DIR="/data/cat/ws/s1787956-cobra/data/cobraII-feats-others-${job_id}-${magnification}x-e${epoch}/${cohort}"
    FEAT_DIR="/data/cat/ws/s1787956-cobra/data/features-others/features-${magnification}x/virchow2/${cohort}/virchow2-stamp-maru-21-12-24"
    SLIDE_TABLE="/data/cat/ws/s1787956-cobra/slide_tables/slide_table_${cohort,,}.csv"
